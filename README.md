...
*server command line:
=====================
MAP_KEY=<map_key> AWS_REGION=&ltregion&gt AWS_ACCESS_KEY_ID=<aws_key> AWS_SECRET_ACCESS_KEY=<aws_secret> java -jar build/libs/denis-map-test_aws_reactive_consumer-1.0.0.jar {lab} {vehicles} {rate} {inputFile}
